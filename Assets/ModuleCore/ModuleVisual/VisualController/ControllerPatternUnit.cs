...
/// 图案单元 - 控制器
/// </summary>
// public class ControllerPatternUnit : VisualController<DataPatternUnit> {
// 	/// <summary> 空间 </summary>
// 	public Transform space;
// 	/// <summary> 预制 </summary>
// 	public Transform prefab;

// 	public override void UpdateVisual(ref DataPatternUnit obj) {
// 		if (obj.visual == null) {
...
// 		BuildMaterial(obj, meshRenderer);
// 	}
// 	public override void ReleaseVisual(DataPatternUnit obj) {
// 		if (obj != null && obj.visual != null) { Destroy(obj.visual); }
// 	}

// 	private void BuildMaterial(DataPatternUnit unit, MeshRenderer meshRenderer) {
